      ...
      >
        ...
        <Grid item sm={6}>
          <Typography variant="h1" gutterBottom>
            {method === 'new' ? 'Add' : 'Edit'} Experiment
          </Typography>
        </Grid>
        <Grid item sm={6}>
          <Typography
        ...
        {method === 'new' ? (
          <Grid item sm={12}>
            <Typography variant="subtitle1" gutterBottom>
              This contribution will fall under Hypothesis
            </Typography>
            <Paper
              style={{
                paddingLeft: '10px',
        ...
        <Grid item sm={6}>
          <Typography
            style={{ color: '#54B358', fontWeight: 'bold' }}
            variant="h3"
            gutterBottom
          >
            Experiment
        ...
        <Grid item sm={12}>
          <Controls.Input
            type="text"
            name="subject"
            label="What is this experiment testing?"
            control={control}
            asterisk
        ...
        <Grid item xs={12}>
          <Controls.Quill
            ...
            asterisk
            control={control}
            label="Experimental Protocol: describe how to perform this experiment"
